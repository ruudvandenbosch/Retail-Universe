...
<div id="content_holder" class="fixed">
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="return">
    ...
    <div class="buttons">
      <div class="left"><a onclick="addReturnProduct();" class="button"><span><?php echo $button_add_product; ?></span></a></div>
    </div>
    <h4><?php echo $text_additional; ?></h4>
    <div class="return-additional">
      <div class="return-comment">
        <textarea name="comment" cols="40" rows="10" style="width: 99%;"><?php echo $comment; ?></textarea>
      </div>
      <div class="return-captcha"><b><?php echo $entry_captcha; ?></b><br />
        <input type="text" name="captcha" value="<?php echo $captcha; ?>" />
        <br />
        <img id="captcha" src="index.php?route=account/return/captcha" alt="" />
