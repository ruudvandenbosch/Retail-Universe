        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
            ...
            <td class="left"><select name="banner_module[<?php echo $module_row; ?>][position]">
                ...
                <option value="content_footer" selected="selected"><?php echo $text_footer; ?></option>
                <?php } else { ?>
                <option value="content_footer"><?php echo $text_footer; ?></option>
                <?php } ?>
              </select></td>
...
function addModule() {	
	...
	html += '      <option value="content_footer"><?php echo $text_footer; ?></option>';
	html += '    </select></td>';
